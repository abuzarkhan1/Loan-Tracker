...
const envSchema = z.object({
  ...
  REDIS_PASSWORD: emptyToUndefined(z.string().optional()),
  ...
  PUBLIC_BASE_URL: emptyToUndefined(z.string().optional()),
  MAX_PROOF_FILE_SIZE_MB: z.coerce.number().positive().default(5),
  SMTP_HOST: emptyToUndefined(z.string().optional()),
  SMTP_PORT: emptyToUndefined(z.coerce.number().int().positive().optional()),
  ...
  PUBLIC_WEBSITE_URL: emptyToUndefined(z.string().optional()),
});
