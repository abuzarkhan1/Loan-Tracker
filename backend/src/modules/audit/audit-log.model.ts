...
export const AUDIT_ACTIONS = [
  ...
  "GOAL_AUTO_PLAN_APPLIED",
  "BILL_CREATED",
  "BILL_UPDATED",
  "BILL_DELETED",
  "BILL_OCCURRENCE_PAID",
  "BILL_OCCURRENCE_SKIPPED",
  "RECURRING_TRANSACTION_CREATED",
  "RECURRING_TRANSACTION_UPDATED",
  "RECURRING_TRANSACTION_DELETED",
  "RECURRING_OCCURRENCE_COMPLETED",
  "TRANSACTION_TEMPLATE_CREATED",
  "TRANSACTION_TEMPLATE_UPDATED",
  "TRANSACTION_TEMPLATE_DELETED",
  "SMART_ENTRY_CONFIRMED",
  "SMART_ENTRY_HISTORY_CLEARED",
  "PRIVACY_SETTINGS_UPDATED",
  "DATA_QUALITY_ISSUE_RESOLVED",
  "SCENARIO_CREATED",
  "SCENARIO_DELETED",
  "REVIEW_GENERATED",
  "CATEGORIZATION_FEEDBACK_SAVED",
] as const;
